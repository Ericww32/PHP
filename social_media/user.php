...
if(isset($_GET["u"])){
    ...
    header("location: http://www.PivotTester.x10.bz");
    exit();	
}
...
if($u == $log_username && $user_ok == true){
	$isOwner = "yes";
	$profile_pic_btn = '<a href="#" onclick="return false;" onmousedown="toggleElement(\'avatar_form\')">Change Picture</a>';
...
if($avatar == NULL){
	$profile_pic = '<img src="images/avatardefault.png" alt="'.$user1.'">';
}
?><?php
$isFriend = false;
...
<link rel="stylesheet" href="style/Pivot_styles.css">
<style type="text/css">
...
div#photo_showcase{float:right; background:url(images/photo_showcase_bg.jpg) no-repeat; width:136px; height:127px; margin:20px 30px 0px 0px; cursor:pointer;}
...
<div id="pageMiddle">
  ...
  <h3><?php echo $u; ?></h3>
  <p><b>ABOUT:</b></p>
  <p>Verified owner: <b><?php echo $isOwner; ?></b></p>
  <p>Country: <?php echo $country; ?></p>
  <p>User Type: <?php echo $userlevel; ?></p>
